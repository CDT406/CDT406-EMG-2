...
def build_model(window_samples, num_classes=4, batch_size=32):
    """Build LSTM model that processes raw preprocessed EMG data"""
    model = Sequential([
        tf.keras.layers.Input(batch_shape=(batch_size, 3, window_samples)),
        # Add dense layer with tanh first
